...
## Frontend-Specific Research
- Check existing components in `src/components/`
- Review feature patterns in `src/features/`
- Understand API contracts in `src/api/`
- Check Backend Pydantic models for type definitions
